...
#ifdef WIN32
/* auto select the appropriate version of the library */
...
#  pragma message ("Linking to lib file: libgfx" SUFFIXM SUFFIXD SUFFIXL ".lib")
#  pragma comment(lib,  "libgfx" SUFFIXM SUFFIXD SUFFIXL ".lib")
#endif
#include <cstdlib>
#include <cmath>
#include <climits>
